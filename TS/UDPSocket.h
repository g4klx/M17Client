...
public:
	...
	int  read(char* buffer, size_t length, sockaddr_storage& address, unsigned int &address_length);
	bool write(const char* buffer, size_t length, const sockaddr_storage& address, unsigned int address_length);
